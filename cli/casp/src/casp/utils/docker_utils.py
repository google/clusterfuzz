...
PROJECT_TO_IMAGE = {
    'dev': ("us-central1-docker.pkg.dev/clusterfuzz-images/clusterfuzz-immutable-images/chromium/base/immutable/dev:"
            "20251008165901-utc-893e97e-640142509185-compute-d609115-prod"),
    'internal': (
        "us-central1-docker.pkg.dev/clusterfuzz-images/clusterfuzz-immutable-images/chromium/base/immutable/internal:"
        "20251110132749-utc-363160d-640142509185-compute-c7f2f8c-prod"),
    'external': ("us-central1-docker.pkg.dev/clusterfuzz-images/clusterfuzz-immutable-images/base/immutable/external:"
