...
if [[ -z $GOOGLE_APPLICATION_CREDENTIALS ]]; then
  ...
  CREDENTIALS_LOCATION=$(dirname $GOOGLE_APPLICATION_CREDENTIALS)
  MOUNT_ARGS="-v $CREDENTIALS_LOCATION:/creds $MOUNT_ARGS"
  GOOGLE_APPLICATION_CREDENTIALS="/creds/$CREDENTIALS_FILENAME"
fi
