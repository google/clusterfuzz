...
from _internal.system.environment import appengine_noop
from _internal.system.environment import bot_noop
from _internal.system.environment import local_noop
