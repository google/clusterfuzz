...
from _internal.bot.tasks import analyze_task
...
from _internal.bot.tasks import progression_task
from _internal.bot.tasks import regression_task
from _internal.bot.tasks import symbolize_task
from _internal.bot.tasks import train_rnn_generator_task
from _internal.bot.tasks import unpack_task
from _internal.bot.tasks import upload_reports_task
from _internal.bot.tasks import variant_task
...
def update_environment_for_job(environment_string):
  ...
  if environment.is_trusted_host():
    ...
    from _internal.bot.untrusted_runner import environment as worker_environment
