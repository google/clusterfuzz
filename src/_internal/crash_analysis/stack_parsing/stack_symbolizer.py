...
from _internal.platforms.android import fetch_artifact
from _internal.platforms.android import settings
from _internal.platforms.android import symbols_downloader
from _internal.platforms.linux import lkl
from _internal.platforms.linux.lkl import constants as lkl_constants
...
def symbolize_stacktrace(unsymbolized_crash_stacktrace,
  ...
  if environment.is_trusted_host():
    from _internal.bot.untrusted_runner import symbolize_host
