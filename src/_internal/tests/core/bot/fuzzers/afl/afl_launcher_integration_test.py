...
class BaseLauncherTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        '_internal.metrics.logs.log', 'os.getpid',
        '_internal.bot.fuzzers.afl.launcher.rand_cmplog_level',
        '_internal.bot.fuzzers.afl.launcher.rand_schedule'
    ])
  ...
  def _test_libfuzzerize_corpus(self, mock_get_timeout):
    ...
    test_helpers.patch(self, [
        '_internal.bot.fuzzers.afl.launcher.AflRunnerCommon.fuzz',
        '_internal.bot.fuzzers.afl.launcher.AflFuzzOutputDirectory.is_testcase'
    ])
...
class TestLauncher(BaseLauncherTest):
  ...
  @mock.patch('_internal.bot.fuzzers.afl.launcher.get_fuzz_timeout')
