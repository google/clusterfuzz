...
class TaskLoopTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        '_internal.base.tasks.get_task',
        '_internal.bot.tasks.commands.process_command',
        '_internal.bot.tasks.update_task.run',
        '_internal.bot.tasks.update_task.track_revision',
    ])
