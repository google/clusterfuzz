...
#currently using edges as bandit metric, can change below by selecting a bandit field for one of the other metrics (features, units, crash)
...
class Handler(base_handler.Handler):
  """Handler to periodically update fuzz strategy bandit probabilities based on performance metric (currently based on new_edges)."""
