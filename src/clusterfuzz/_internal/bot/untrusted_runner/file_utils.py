...
def file_chunk_generator(
    handle: BinaryIO) -> Iterator[untrusted_runner_pb2.FileChunk]:
...
def data_chunk_generator(
    data: bytes) -> Iterator[untrusted_runner_pb2.FileChunk]:
...
def write_chunks(
    file_path: str,
    chunk_iterator: Iterable[untrusted_runner_pb2.FileChunk]) -> None:
