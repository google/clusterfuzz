...
def create_testcase_list_file(testcase_file_paths: Sequence[str],
...
def is_locked(input_directory: str) -> bool:
...
def get_random_testcases(input_directory: str, max_testcases: int) -> list[str]:
...
def get_testcases(input_directory: str) -> list[str]:
