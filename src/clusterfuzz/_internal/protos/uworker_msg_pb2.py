...
_FUZZTASKOUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='store_fuzzer_run_results_output', full_name='FuzzTaskOutput.store_fuzzer_run_results_output', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='new_targets_count', full_name='FuzzTaskOutput.new_targets_count', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fuzzer_revision', full_name='FuzzTaskOutput.fuzzer_revision', index=10,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_store_fuzzer_run_results_output', full_name='FuzzTaskOutput._store_fuzzer_run_results_output',
      index=8, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
...
_FUZZTASKOUTPUT.fields_by_name['store_fuzzer_run_results_output'].message_type = _STOREFUZZERRUNRESULTSOUTPUT
...
_FUZZTASKOUTPUT.oneofs_by_name['_store_fuzzer_run_results_output'].fields.append(
  _FUZZTASKOUTPUT.fields_by_name['store_fuzzer_run_results_output'])
_FUZZTASKOUTPUT.fields_by_name['store_fuzzer_run_results_output'].containing_oneof = _FUZZTASKOUTPUT.oneofs_by_name['_store_fuzzer_run_results_output']
