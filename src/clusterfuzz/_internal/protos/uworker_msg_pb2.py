...
_ERRORTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='PARTIAL_MINIMIZATION_DEADLINE_EXCEEDED', index=26, number=26,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LIBFUZZER_MINIMIZATION_UNREPRODUCIBLE', index=27, number=27,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='LIBFUZZER_MINIMIZATION_FAILED', index=28, number=28,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
PARTIAL_MINIMIZATION_DEADLINE_EXCEEDED = 26
LIBFUZZER_MINIMIZATION_UNREPRODUCIBLE = 27
LIBFUZZER_MINIMIZATION_FAILED = 28
...
_MINIMIZETASKOUTPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='repro_command', full_name='MinimizeTaskOutput.repro_command', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='memory_tool_options', full_name='MinimizeTaskOutput.memory_tool_options', index=11,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_repro_command', full_name='MinimizeTaskOutput._repro_command',
      index=8, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
  ],
...
_MINIMIZETASKOUTPUT.oneofs_by_name['_repro_command'].fields.append(
  _MINIMIZETASKOUTPUT.fields_by_name['repro_command'])
_MINIMIZETASKOUTPUT.fields_by_name['repro_command'].containing_oneof = _MINIMIZETASKOUTPUT.oneofs_by_name['_repro_command']
