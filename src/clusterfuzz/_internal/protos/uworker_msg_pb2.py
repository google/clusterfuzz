...
_FUZZTASKINPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sample_testcase_upload_keyw', full_name='FuzzTaskInput.sample_testcase_upload_keyw', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_sample_testcase_upload_keyw', full_name='FuzzTaskInput._sample_testcase_upload_keyw',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
...
_FUZZTASKINPUT.oneofs_by_name['_sample_testcase_upload_keyw'].fields.append(
  _FUZZTASKINPUT.fields_by_name['sample_testcase_upload_keyw'])
_FUZZTASKINPUT.fields_by_name['sample_testcase_upload_keyw'].containing_oneof = _FUZZTASKINPUT.oneofs_by_name['_sample_testcase_upload_keyw']
