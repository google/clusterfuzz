...
_INPUT_PROGRESSIONUWORKERENVENTRY = _descriptor.Descriptor(
  name='ProgressionUworkerEnvEntry',
  full_name='Input.ProgressionUworkerEnvEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='Input.ProgressionUworkerEnvEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='Input.ProgressionUworkerEnvEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='progression_uworker_env', full_name='Input.progression_uworker_env', index=18,
  ...
  nested_types=[_INPUT_PROGRESSIONUWORKERENVENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_INPUT_PROGRESSIONUWORKERENVENTRY.containing_type = _INPUT
...
_INPUT.fields_by_name['progression_uworker_env'].message_type = _INPUT_PROGRESSIONUWORKERENVENTRY
...
Input = _reflection.GeneratedProtocolMessageType('Input', (_message.Message,), {
  ...
  'ProgressionUworkerEnvEntry' : _reflection.GeneratedProtocolMessageType('ProgressionUworkerEnvEntry', (_message.Message,), {
    'DESCRIPTOR' : _INPUT_PROGRESSIONUWORKERENVENTRY,
    '__module__' : 'clusterfuzz._internal.protos.uworker_msg_pb2'
    # @@protoc_insertion_point(class_scope:Input.ProgressionUworkerEnvEntry)
    })
  ,
  'DESCRIPTOR' : _INPUT,
  '__module__' : 'clusterfuzz._internal.protos.uworker_msg_pb2'
...
_sym_db.RegisterMessage(Input.ProgressionUworkerEnvEntry)
...
_INPUT_PROGRESSIONUWORKERENVENTRY._options = None
