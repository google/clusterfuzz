...
from clusterfuzz._internal.swarming import service as swarming_service
...
class RemoteTaskAdapters(Enum):
  ...
  SWARMING = ('swarming', swarming_service.SwarmingService,
              feature_flags.FeatureFlags.SWARMING_JOBS_FREQUENCY, 0.0)
