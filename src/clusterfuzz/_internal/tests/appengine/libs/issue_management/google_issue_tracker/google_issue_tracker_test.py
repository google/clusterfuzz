...
import unittest
from clusterfuzz._internal.issue_management.google_issue_tracker import issue_tracker
...
BASIC_ISSUE = {
    ...
    "issueState": {
        ...
        "severity": "S2",
        "title": "test",
        "reporter": {"emailAddress": "user1@google.com", "userGaiaStatus": "ACTIVE"},
        "assignee": {"emailAddress": "assignee@google.com", "userGaiaStatus": "ACTIVE"},
        "retention": "COMPONENT_DEFAULT",
    },
    "createdTime": "2019-06-25T01:29:30.021Z",
    "modifiedTime": "2019-06-25T01:29:30.021Z",
    "userData": {},
    "accessLimit": {"accessLevel": "INTERNAL"},
    "etag": "TmpnNE1qZzVNemd0TUMweA==",
    "lastModifier": {"emailAddress": "user1@google.com", "userGaiaStatus": "ACTIVE"},
}
...
class GoogleIssueTrackerTest(unittest.TestCase):
    ...
    def test_get_ccs(self):
        ...
        self.client.issues().get().execute.return_value = {
            ...
            "issueState": {
                ...
                "title": "test",
                "ccs": [
                    {"emailAddress": "user1@google.com", "userGaiaStatus": "ACTIVE"},
                    {"emailAddress": "user2@google.com", "userGaiaStatus": "ACTIVE"},
                ],
            },
        }
        issue = self.issue_tracker.get_issue(68823253)
    ...
    def test_new_issue(self):
        ...
        self.client.issues().create.assert_has_calls(
            [
                mock.call(
                    body={
                        "issueComment": {"comment": "issue body"},
                        "issueState": {
                            "status": "ASSIGNED",
                            "reporter": {"emailAddress": "reporter@google.com"},
                            "title": "issue title",
                            "ccs": [{"emailAddress": "cc@google.com"}],
                            "assignee": {"emailAddress": "assignee@google.com"},
                            "componentId": 9001,
                            "hotlistIds": [12345],
                            "type": "BUG",
                        },
    ...
    def test_update_issue(self):
        ...
        self.client.issues().modify().execute.return_value = {
            ...
            "issueState": {
                ...
                "retention": "COMPONENT_DEFAULT",
                "ccs": [
                    {"emailAddress": "cc@google.com", "userGaiaStatus": "ACTIVE"},
                ],
                "hotlistIds": [
                    "12345",
                ],
            ...
            [
                mock.call(
                    body={
                        "add": {
                            "status": "ASSIGNED",
                            "assignee": {"emailAddress": "assignee2@google.com"},
                            "ccs": [{"emailAddress": "cc@google.com"}],
                            "reporter": {"emailAddress": "reporter@google.com"},
                            "title": "issue title2",
                        },
        ...
        self.client.hotlists().createEntries.assert_has_calls(
            [
                mock.call(
                    body={"hotlistEntry": {"issueId": "68828938"}}, hotlistId="12345"
                ),
                mock.call().execute(http=None, num_retries=3),
            ]
        )
    ...
    def test_find_issues_url(self):
        ...
        self.assertEqual(
            "https://issuetracker.googleapis.com/v1/issues?q=%22abc%22+%22def%22", url
        )
