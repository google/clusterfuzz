...
class StackAnalyzerTestcase(unittest.TestCase):
  ...
  def test_centipede_timeout_old(self):
    """Test the old centipede timeout stacktrace (with reporting enabled)."""
    os.environ['REPORT_OOMS_AND_HANGS'] = 'True'
  ...
  def test_check_eq_multiline2(self):
    """Tests a Chromium CHECK failure with multi-line additional details."""
    data = self._read_test_data('check_eq_multiline2.txt')
    expected_type = 'CHECK failure'
    expected_address = ''
    expected_state = (
