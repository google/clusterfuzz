...
from internal.bot.fuzzers.afl import constants
from internal.bot.fuzzers.afl import stats
from internal.bot.fuzzers.afl import strategies
from internal.bot.fuzzers.afl.fuzzer import write_dummy_file
from internal.datastore import data_types
from internal.fuzzing import strategy
from internal.metrics import logs
from internal.metrics import profiler
...
class AflRunnerCommon(object):
  ...
  def run_afl_fuzz(self, fuzz_args):
    ...
    while self.should_try_fuzzing(max_total_time, num_retries):
      ...
      # from internal.fuzzing (and not in the input) it will exit with a zero return
      # code.
