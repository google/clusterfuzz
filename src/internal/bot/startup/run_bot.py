...
from internal.base import untrusted
from internal.base import utils
from internal.bot.fuzzers import init as fuzzers_init
from internal.bot.tasks import update_task
...
def main():
  ...
  if environment.is_untrusted_worker():
    ...
    from internal.bot.untrusted_runner import untrusted as untrusted_worker
