...
from internal.bot.tasks import analyze_task
from internal.bot.tasks import blame_task
...
from internal.bot.tasks import minimize_task
from internal.bot.tasks import progression_task
from internal.bot.tasks import regression_task
from internal.bot.tasks import symbolize_task
from internal.bot.tasks import train_rnn_generator_task
from internal.bot.tasks import unpack_task
from internal.bot.tasks import upload_reports_task
from internal.bot.tasks import variant_task
from internal.bot.webserver import http_server
...
def update_environment_for_job(environment_string):
  ...
  if environment.is_trusted_host():
    ...
    from internal.bot.untrusted_runner import environment as worker_environment
