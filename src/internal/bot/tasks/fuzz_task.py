...
from internal.bot.fuzzers import builtin
from internal.bot.fuzzers import builtin_fuzzers
from internal.bot.fuzzers import engine_common
from internal.bot.fuzzers import utils as fuzzer_utils
from internal.bot.fuzzers.libFuzzer import stats as libfuzzer_stats
from internal.bot.tasks import setup
from internal.bot.tasks import task_creation
from internal.bot.tasks import trials
from internal.build_management import build_manager
from internal.chrome import crash_uploader
from collections import namedtuple
from internal.crash_analysis import crash_analyzer
from internal.crash_analysis.crash_result import CrashResult
from internal.crash_analysis.stack_parsing import stack_analyzer
...
from internal.fuzzing import coverage_uploader
from internal.fuzzing import fuzzer_selection
from internal.fuzzing import gesture_handler
...
from internal.system import process_handler
...
class GcsCorpus(object):
  ...
  def __init__(self, engine_name, project_qualified_target_name,
    ...
    if environment.is_trusted_host():
      from internal.bot.untrusted_runner import corpus_manager as remote_corpus_manager
...
def run_engine_fuzzer(engine_impl, target_name, sync_corpus_directory,
  ...
  if environment.is_trusted_host():
    from internal.bot.untrusted_runner import tasks_host
