...
@retry.wrap(
    ...
    function='internal.google_cloud_utils.big_query.get_api_client')
def get_api_client():
...
class Client(object):
  ...
  @retry.wrap(
      retries=QUERY_RETRY_COUNT,
      delay=QUERY_RETRY_DELAY,
      function='internal.google_cloud_utils.big_query.Client.raw_query')
  ...
  @retry.wrap(
      retries=QUERY_RETRY_COUNT,
      delay=QUERY_RETRY_DELAY,
      function='internal.google_cloud_utils.big_query.Client.get_query_results')
  ...
  @retry.wrap(
      retries=QUERY_RETRY_COUNT,
      delay=QUERY_RETRY_DELAY,
      function='internal.google_cloud_utils.big_query.Client.get_job')
  ...
  @retry.wrap(
      retries=QUERY_RETRY_COUNT,
      delay=QUERY_RETRY_DELAY,
      function='internal.google_cloud_utils.big_query.Client.insert_from_query')
  ...
  @retry.wrap(
      retries=QUERY_RETRY_COUNT,
      delay=QUERY_RETRY_DELAY,
      function='internal.google_cloud_utils.big_query.Client.insert')
