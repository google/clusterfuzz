...
from internal.datastore import locks
...
@retry.wrap(
    ...
    function='internal.google_cloud_utils.storage.copy_file_from',
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.copy_file_to',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.copy_blob',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.delete',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.exists')
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.last_updated',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.read_data',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.write_data',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.get_blobs',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.list_blobs',
    exception_type=google.cloud.exceptions.GoogleCloudError)
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.'
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.file_exists_in_cache')
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.get')
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.get_acl')
...
@retry.wrap(
    retries=DEFAULT_FAIL_RETRIES,
    delay=DEFAULT_FAIL_WAIT,
    function='internal.google_cloud_utils.storage.set_acl')
