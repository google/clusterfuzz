...
class GetTestcaseTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        ...
        'internal.build_management.revisions.get_component_revisions_dict',
        'internal.config.db_config.get',
        'internal.config.db_config.get_value',
        'internal.config.db_config.get_value_for_job',
        'internal.datastore.data_handler.get_stacktrace',
        ...
        'internal.metrics.crash_stats.get_last_crash_time',
    ])
