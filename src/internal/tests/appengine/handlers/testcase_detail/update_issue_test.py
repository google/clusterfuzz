...
class HandlerTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, [
        'internal.datastore.data_handler.get_issue_description',
        'internal.datastore.data_handler.get_issue_summary',
        'internal.datastore.data_handler.get_stacktrace',
        'internal.datastore.data_handler.update_group_bug',
