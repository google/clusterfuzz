...
class GetUserJobTypeTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(
        self, ['internal.config.db_config.get_value', 'libs.helpers.get_user_email'])
...
class IsPrivilegedUserTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, ['internal.config.db_config.get_value'])
  ...
  def test_all_users_privileged(self):
    ...
    test_helpers.patch(self, ['internal.config.local_config.AuthConfig'])
...
class IsDomainAllowedTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, ['internal.config.local_config.AuthConfig.get'])
...
class GetAccessTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, [
        ...
        'internal.base.external_users.is_fuzzer_allowed_for_user',
        'internal.base.external_users.is_job_allowed_for_user',
    ])
