...
def no_errors(f):
  ...
  def call_f(self, *args, **kwargs):
    test_helpers.patch(self, ['internal.metrics.logs.log_error'])
...
class BaseLauncherTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, ['internal.metrics.logs.log', 'os.getpid'])
  ...
  def _test_libfuzzerize_corpus(self, mock_get_timeout):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.afl.launcher.AflRunnerCommon.fuzz',
        'internal.bot.fuzzers.afl.launcher.AflFuzzOutputDirectory.is_testcase'
    ])
...
class TestLauncher(BaseLauncherTest):
  ...
  @mock.patch('internal.bot.fuzzers.afl.launcher.get_fuzz_timeout')
...
class TestLauncherMinijail(BaseLauncherTest):
  ...
  def setUp(self):
    super().setUp()
    test_helpers.patch(self, ['internal.system.minijail.MinijailChroot._mknod'])
