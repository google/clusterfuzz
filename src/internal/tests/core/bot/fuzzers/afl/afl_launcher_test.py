...
from internal.bot.fuzzers.afl import fuzzer
from internal.bot.fuzzers.afl import launcher
from internal.bot.fuzzers.afl import strategies
...
class LauncherTestBase(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.utils.get_temp_dir',
    ])
...
class FuzzingStrategiesTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, ['internal.bot.fuzzers.engine_common.is_lpm_fuzz_target'])
  ...
  def test_decide_fast_cal_random_finds_correct_prob(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.engine_common.decide_with_probability',
    ])
...
class AflRunnerTest(LauncherTestBase):
  ...
  def test_fuzzer_stderr_ioerror(self):
    ...
    stderr file."""
    test_helpers.patch(self, ['internal.base.utils.read_from_handle_truncated'])
  ...
  def _initialization_for_run_afl(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.afl.launcher.AflRunner.run_and_wait',
    ])
  ...
  @mock.patch('internal.metrics.logs.log_error')
...
def dont_use_strategies(obj):
  ...
  test_helpers.patch(obj, [
      'internal.bot.fuzzers.engine_common.decide_with_probability',
      'internal.bot.fuzzers.afl.launcher.FuzzingStrategies.decide_fast_cal_manual',
      'internal.bot.fuzzers.afl.launcher.FuzzingStrategies.decide_fast_cal_random',
  ])
