...
from internal.bot.fuzzers import engine_common
from internal.bot.fuzzers import libfuzzer
from internal.bot.fuzzers import strategy_selection
from internal.bot.fuzzers import utils as fuzzer_utils
from internal.bot.fuzzers.libFuzzer import constants
from internal.bot.fuzzers.libFuzzer import engine
from internal.build_management import build_manager
from internal.fuzzing import strategy
from internal.metrics import logs
from internal.platforms import android
from internal.system import environment
from internal.system import new_process
from internal.system import shell
...
class PrepareTest(fake_fs_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.engine_common.unpack_seed_corpus_if_needed',
    ])
    ...
    test_helpers.patch(self, ['internal.bot.fuzzers.libfuzzer.pick_strategies'])
...
class PickStrategiesTest(fake_fs_unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, [
        'internal.bot.fuzzers.engine_common.is_lpm_fuzz_target',
...
class FuzzTest(fake_fs_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.libFuzzer.engine._is_multistep_merge_supported',
        'internal.bot.fuzzers.libfuzzer.LibFuzzerRunner.fuzz',
        'internal.bot.fuzzers.libfuzzer.LibFuzzerRunner.merge',
        'os.getpid',
    ])
...
class BaseIntegrationTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.dictionary_manager.DictionaryManager.'
        'update_recommended_dictionary',
        'internal.bot.fuzzers.engine_common.get_merge_timeout',
        'internal.bot.fuzzers.engine_common.random_choice',
        'internal.bot.fuzzers.mutator_plugin._download_mutator_plugin_archive',
        'internal.bot.fuzzers.mutator_plugin._get_mutator_plugins_from_bucket',
        'internal.bot.fuzzers.strategy_selection.generate_weighted_strategy_pool',
        'internal.bot.fuzzers.libfuzzer.get_dictionary_analysis_timeout',
        'internal.bot.fuzzers.libfuzzer.get_fuzz_timeout',
        'os.getpid',
        'internal.system.minijail.MinijailChroot._mknod',
    ])
...
class IntegrationTests(BaseIntegrationTest):
  ...
  def test_merge_reductions(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.libFuzzer.engine.LibFuzzerEngine._create_merge_corpus_dir',
        'internal.system.shell.get_directory_file_count',
    ])
  ...
  def test_exit_failure_logged(self):
    ...
    error."""
    test_helpers.patch(self, [
        'internal.metrics.logs.log_error',
    ])
...
class IntegrationTestsFuchsia(BaseIntegrationTest):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.system.shell.clear_temp_directory',
    ])
  ...
  def test_qemu_logs_returned_on_error(self):
    ...
    test_helpers.patch(self, ['internal.metrics.logs.log_warn'])
