...
class HTMLMinimizerTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(
        self,
        [('js_minimizer', 'internal.bot.minimizer.js_minimizer.JSMinimizer.minimize'),
         ('html_minimizer',
          'internal.bot.minimizer.chunk_minimizer.ChunkMinimizer.minimize'),
         ('line_minimizer',
          'internal.bot.minimizer.delta_minimizer.DeltaMinimizer.minimize')])
