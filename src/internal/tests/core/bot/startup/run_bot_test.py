...
from internal.bot.startup import run_bot
...
class TaskLoopTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.base.tasks.get_task',
        'internal.bot.tasks.commands.process_command',
        'internal.bot.tasks.update_task.run',
        'internal.bot.tasks.update_task.track_revision',
    ])
