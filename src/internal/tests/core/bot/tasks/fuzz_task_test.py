...
from internal.bot import testcase_manager
from internal.bot.fuzzers.libFuzzer import engine as libfuzzer_engine
from internal.bot.tasks import fuzz_task
from internal.bot.untrusted_runner import file_host
from internal.build_management import build_manager
from internal.chrome import crash_uploader
...
from internal.lib.clusterfuzz import stacktraces
from internal.lib.clusterfuzz.fuzz import engine
from internal.metrics import monitor
from internal.metrics import monitoring_metrics
...
class GetRegressionTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, ['internal.build_management.build_manager.is_custom_binary'])
...
class CrashInitTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.chrome.crash_uploader.FileMetadataInfo',
        'internal.bot.tasks.setup.archive_testcase_and_dependencies_in_gcs',
        'internal.crash_analysis.stack_parsing.stack_analyzer.get_crash_data',
        'internal.bot.testcase_manager.get_additional_command_line_flags',
        'internal.bot.testcase_manager.get_command_line_for_application',
        'internal.base.utils.get_crash_stacktrace_output',
        'internal.crash_analysis.crash_analyzer.ignore_stacktrace',
        'internal.crash_analysis.crash_analyzer.is_security_issue',
    ])
...
class CrashGroupTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        'internal.bot.tasks.fuzz_task.find_main_crash',
        'internal.datastore.data_handler.find_testcase',
        'internal.datastore.data_handler.get_project_name',
    ])
...
class FindMainCrashTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        'internal.bot.testcase_manager.test_for_reproducibility',
    ])
    self.crashes = [
        self._make_crash('g1'),
        self._make_crash('g2'),
...
class ProcessCrashesTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.chrome.crash_uploader.get_symbolized_stack_bytes',
        'internal.bot.tasks.fuzz_task.get_unsymbolized_crash_stacktrace',
        'internal.bot.tasks.task_creation.create_tasks',
        'internal.bot.tasks.setup.archive_testcase_and_dependencies_in_gcs',
        'internal.crash_analysis.stack_parsing.stack_analyzer.get_crash_data',
        'internal.build_management.revisions.get_real_revision',
        'internal.bot.testcase_manager.get_command_line_for_application',
        'internal.bot.testcase_manager.test_for_reproducibility',
        'internal.base.utils.get_crash_stacktrace_output',
        'internal.crash_analysis.crash_analyzer.ignore_stacktrace',
        'internal.crash_analysis.crash_analyzer.is_security_issue',
        'internal.datastore.data_handler.get_issue_tracker_name',
        'internal.datastore.data_handler.get_project_name',
        'internal.google_cloud_utils.big_query.Client.insert',
        'internal.google_cloud_utils.big_query.get_api_client', 'time.sleep', 'time.time'
    ])
    test_utils.set_up_pyfakefs(self)
...
class WriteCrashToBigQueryTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.system.environment.get_value',
        'internal.datastore.data_handler.get_project_name',
        'internal.google_cloud_utils.big_query.Client',
        'time.time',
    ])
    monitor.metrics_store().reset_for_testing()
...
class TestCorpusSync(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        ...
        'internal.google_cloud_utils.storage.last_updated',
    ])
...
class RecordFuzzTargetTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch_environ(self)
    helpers.patch(self, [
        'internal.base.utils.is_oss_fuzz',
        'internal.base.utils.utcnow',
    ])
...
class DoBlackboxFuzzingTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch_environ(self)
    helpers.patch(self, [
        'internal.base.utils.random_element_from_list',
        'internal.base.utils.random_number',
        'internal.bot.fuzzers.engine_common.current_timestamp',
        'internal.bot.tasks.fuzz_task.pick_gestures',
        'internal.bot.testcase_manager.upload_log',
        'internal.bot.testcase_manager.upload_testcase',
        'internal.build_management.revisions.get_component_list',
        'internal.crash_analysis.crash_analyzer.is_crash',
        'internal.crash_analysis.stack_parsing.stack_analyzer.get_crash_data',
        'internal.datastore.ndb_init.context',
        'internal.metrics.fuzzer_stats.upload_stats',
        'random.random',
        'internal.system.process_handler.close_queue',
        'internal.system.process_handler.get_process',
        'internal.system.process_handler.get_queue',
        'internal.system.process_handler.run_process',
        'internal.system.process_handler.terminate_hung_threads',
        'internal.system.process_handler.terminate_stale_application_instances',
    ])
...
class DoEngineFuzzingTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.bot.fuzzers.engine_common.current_timestamp',
        'internal.bot.tasks.fuzz_task.GcsCorpus.sync_from_gcs',
        'internal.bot.tasks.fuzz_task.GcsCorpus.upload_files',
        'internal.build_management.revisions.get_component_list',
        'internal.bot.testcase_manager.upload_log',
        'internal.bot.testcase_manager.upload_testcase',
        'internal.metrics.fuzzer_stats.upload_stats',
