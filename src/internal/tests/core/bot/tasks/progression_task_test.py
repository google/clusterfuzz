...
class WriteToBigqueryTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        'internal.google_cloud_utils.big_query.write_range',
    ])
...
class TestcaseReproducesInRevisionTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        ...
        'internal.bot.testcase_manager.check_for_bad_build',
    ])
...
class UpdateIssueMetadataTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        ...
        'internal.bot.fuzzers.engine_common.get_all_issue_metadata',
    ])
...
class StoreTestcaseForRegressionTesting(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.google_cloud_utils.storage.copy_file_to',
    ])
