...
class RequestBisectionTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        'internal.build_management.build_manager.get_primary_bucket_path',
        'internal.build_management.build_manager.get_revisions_list',
        'internal.build_management.revisions.get_component_range_list',
        'internal.config.local_config.ProjectConfig',
        'internal.google_cloud_utils.blobs.read_key',
        'internal.google_cloud_utils.pubsub.PubSubClient.publish',
    ])
