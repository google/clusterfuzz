...
from internal.bot.fuzzers.ml.rnn import constants
...
class ExecuteTaskTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.tasks.ml_train_utils.get_corpus',
        'internal.bot.tasks.train_rnn_generator_task.train_rnn',
        'internal.bot.tasks.train_rnn_generator_task.upload_model_to_gcs',
    ])
