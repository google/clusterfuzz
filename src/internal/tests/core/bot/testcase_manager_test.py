...
from internal.bot.fuzzers.libFuzzer import constants as libfuzzer_constants
...
class UploadTestcaseOutputTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        ...
        'internal.google_cloud_utils.storage.write_data',
        'datetime.datetime',
    ])
...
class ConvertDependencyUrlToLocalPathTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.webserver.http_server.get_absolute_testcase_file',
        'internal.system.environment.platform',
        'internal.base.utils.normalize_path',
    ])
...
class GetResourcePathsTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, [
        'internal.bot.testcase_manager.convert_dependency_url_to_local_path',
    ])
...
class TestcaseRunningTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.engine_common.find_fuzzer_path',
