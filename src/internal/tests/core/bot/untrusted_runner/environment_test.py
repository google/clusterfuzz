...
from internal.bot.untrusted_runner import environment
...
@mock.patch('internal.bot.untrusted_runner.environment.FORWARDED_ENVIRONMENT_VARIABLES',
            FORWARDED_ENVIRONMENT_VARIABLES)
@mock.patch('internal.bot.untrusted_runner.environment.REBASED_ENVIRONMENT_VARIABLES',
