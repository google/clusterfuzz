...
from internal.protos import untrusted_runner_pb2
...
class FileHostTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, [
        'internal.bot.untrusted_runner.host.stub',
    ])
  ...
  @mock.patch('internal.bot.untrusted_runner.file_host.remove_directory')
  @mock.patch('internal.bot.untrusted_runner.file_host.copy_file_to_worker')
  ...
  @mock.patch('internal.bot.untrusted_runner.file_host.list_files')
  @mock.patch('internal.bot.untrusted_runner.file_host.copy_file_from_worker')
