...
class TrunkBuildTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.build_management.build_manager._setup_build_directories',
        'internal.build_management.build_manager.get_build_urls_list',
        'internal.build_management.build_manager.setup_regular_build',
    ])
...
class RegularBuildTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.build_management.build_manager.get_build_urls_list',
        'internal.build_management.build_manager.Build._unpack_build',
...
class RegularLibFuzzerBuildTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.bot.fuzzers.utils.get_fuzz_targets',
        'internal.build_management.build_manager.get_build_urls_list',
        'internal.build_management.build_manager.Build._get_fuzz_targets_from_archive',
        'internal.build_management.build_manager._make_space',
        'internal.build_management.build_manager._make_space_for_build',
        'internal.system.shell.clear_temp_directory',
        'internal.google_cloud_utils.storage.copy_file_from',
        'internal.google_cloud_utils.storage.get_download_file_size',
        'internal.system.archive.unpack',
        'time.time',
    ])
...
class SymbolizedBuildTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.build_management.build_manager.get_build_urls_list',
        'internal.build_management.build_manager.Build._unpack_build',
        'internal.system.shell.clear_temp_directory', 'time.time'
    ])
...
class CustomBuildTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.build_management.build_manager._make_space_for_build',
        'internal.system.shell.clear_temp_directory',
        'internal.google_cloud_utils.blobs.read_blob_to_disk',
        'internal.system.archive.unpack',
        'time.sleep',
        'time.time',
    ])
...
@mock.patch('internal.build_management.build_manager.MAX_EVICTED_BUILDS', 3)
class BuildEvictionTests(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_utils.set_up_pyfakefs(self)
    test_helpers.patch(self, [
        'internal.base.utils.is_chromium',
        'internal.system.shell.get_free_disk_space',
        'internal.system.archive.extracted_size',
    ])
...
class SplitFuzzTargetsBuildTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        ...
        'internal.google_cloud_utils.storage.copy_file_from',
        'internal.google_cloud_utils.storage.get_download_file_size',
        'internal.google_cloud_utils.storage.list_blobs',
        'internal.google_cloud_utils.storage.read_data',
        'internal.system.archive.unpack',
        'time.time',
    ])
    ...
    os.environ['FUZZER_DIR'] = os.path.join(
        os.environ['ROOT_DIR'], 'src', 'clusterfuzz', 'bot', 'fuzzers', 'libFuzzer')
