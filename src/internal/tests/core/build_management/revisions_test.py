...
class RevisionsTestcase(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.base.utils.default_project_name',
        'internal.base.memoize.FifoOnDisk.get',
        'internal.base.memoize.FifoOnDisk.put',
        'internal.config.local_config.ProjectConfig',
    ])
  ...
  @mock.patch('internal.config.db_config.get')
  @mock.patch('internal.build_management.revisions._get_url_content')
  @mock.patch(
      'internal.build_management.revisions._git_commit_position_to_git_hash_for_chromium'
  )
