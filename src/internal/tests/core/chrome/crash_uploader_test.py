...
from internal.protos import process_state_pb2
...
class CrashBaseTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(
        self,
        ['internal.crash_analysis.stack_parsing.stack_symbolizer.filter_binary_path'])
...
class CrashReportsTest(CrashBaseTest):
  ...
  @mock.patch('internal.platforms.android.adb.run_shell_command')
  @mock.patch('internal.platforms.android.adb.run_command')
  ...
  @mock.patch('internal.google_cloud_utils.blobs.write_blob')
