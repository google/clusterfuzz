...
class DataHandlerTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        ...
        ('project_config_get', 'internal.config.local_config.ProjectConfig.get'),
    ])
...
class GetSecuritySeverityTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, [
        'internal.crash_analysis.severity_analyzer.get_security_severity',
    ])
    self.gestures = ''
...
class UpdateTestcaseCommentTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch_environ(self)
    helpers.patch(self, [
        'internal.base.utils.current_date_time',
    ])
