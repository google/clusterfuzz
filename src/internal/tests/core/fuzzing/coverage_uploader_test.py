...
class UploadTestsToCloudStorageTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        ...
        'internal.config.local_config.ProjectConfig.get',
        'internal.datastore.locks.acquire_lock',
        'internal.datastore.locks.release_lock',
        'internal.google_cloud_utils.gsutil.GSUtilRunner',
