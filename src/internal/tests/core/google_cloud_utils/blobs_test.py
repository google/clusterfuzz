...
class BlobsTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    helpers.patch(self, [
        'internal.system.environment.is_running_on_app_engine',
        'internal.google_cloud_utils.blobs.generate_new_blob_name',
        'internal.google_cloud_utils.storage.copy_file_from',
        'internal.google_cloud_utils.storage.copy_file_to',
        'internal.google_cloud_utils.storage.delete',
        'internal.google_cloud_utils.storage.read_data',
        'internal.google_cloud_utils.storage.get',
    ])
