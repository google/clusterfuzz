...
class GetSourceLocationTest(unittest.TestCase):
  ...
  def test_get(self):
    ...
    self.assertTrue(
        pathname.endswith('src/internal/tests/core/metrics/logs_test.py'))
...
class FormatRecordTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, ['internal.metrics.logs.update_entry_with_exc'])
...
class JsonSocketHandler(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, ['internal.metrics.logs.format_record'])
...
class ConfigureTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch_environ(self)
    helpers.patch(self, [
        'internal.metrics.logs.get_logging_config_dict',
        'internal.metrics.logs.set_logger',
        'logging.config.dictConfig',
        'logging.getLogger',
        'internal.metrics.logs._is_running_on_app_engine',
        'internal.metrics.logs.suppress_unwanted_warnings',
...
class EmitTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(
        self,
        ['internal.metrics.logs.get_logger', 'internal.metrics.logs._is_running_on_app_engine'])
...
class LogErrorTest(unittest.TestCase):
  ...
  def setUp(self):
    helpers.patch(self, ['internal.metrics.logs.emit', 'sys.exc_info'])
