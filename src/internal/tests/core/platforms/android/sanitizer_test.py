...
from internal.platforms.android import adb
from internal.platforms.android import constants
from internal.platforms.android import sanitizer
...
class GetOptionsFilePathTest(android_helpers.AndroidTest):
  ...
  def test_regular_build(self):
    ...
    test_helpers.patch(self,
                       ['internal.platforms.android.settings.get_sanitizer_tool_name'])
