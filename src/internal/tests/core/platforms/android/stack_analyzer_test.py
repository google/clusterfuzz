...
class AndroidStackAnalyzerTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.crash_analysis.stack_parsing.stack_symbolizer.symbolize_stacktrace',
  ...
  def test_syzkaller_kasan_android_with_env(self):
    ...
    test_helpers.patch(self, [
        'internal.platforms.android.fetch_artifact.get',
        'internal.platforms.android.kernel_utils.get_kernel_hash_and_build_id',
        'internal.platforms.android.kernel_utils.get_kernel_name',
        'internal.platforms.android.settings.get_product_brand',
        'internal.google_cloud_utils.storage.get_file_from_cache_if_exists',
        'internal.google_cloud_utils.storage.store_file_in_cache',
        'internal.base.utils.write_data_to_file', 'internal.base.utils.read_data_from_file'
    ])
