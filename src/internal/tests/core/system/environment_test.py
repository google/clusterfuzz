...
class GetExecutableFileNameTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, ['internal.system.environment.platform'])
...
class ParseMemoryToolOptionsTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self,
                       ['internal.metrics.logs.log_warn', 'internal.metrics.logs.log_error'])
...
class ResetCurrentMemoryToolOptionsTest(unittest.TestCase):
  ...
  def test_windows_symbolizer(self):
    ...
    test_helpers.patch(self, [
        ...
        'internal.system.environment.get_llvm_symbolizer_path'
    ])
    self.mock.platform.return_value = 'WINDOWS'
...
class AppEngineNoopTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch(self, ['internal.system.environment.is_running_on_app_engine'])
...
class LocalNoopTest(unittest.TestCase):
  ...
  def setUp(self):
    test_helpers.patch_environ(self)
    test_helpers.patch(
        self, ['internal.system.environment.is_running_on_app_engine_development'])
