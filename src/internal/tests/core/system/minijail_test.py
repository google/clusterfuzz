...
class MinijailTest(fake_filesystem_unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.system.minijail._get_minijail_path',
  ...
  @mock.patch('internal.system.minijail.os.getuid', lambda: 1000)
  ...
  @mock.patch('internal.system.minijail.os.getuid', lambda: 1000)
  @mock.patch('internal.system.minijail.subprocess.Popen')
  @mock.patch('internal.system.minijail.tempfile.NamedTemporaryFile')
