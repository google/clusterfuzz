...
from internal.bot.untrusted_runner import untrusted
from internal.datastore import data_types
from internal.google_cloud_utils import pubsub
...
class UntrustedRunnerIntegrationTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_helpers.patch(self, [
        'internal.datastore.data_handler.get_data_bundle_bucket_name',
        'internal.system.environment.set_environment_parameters_from_file',
    ])
