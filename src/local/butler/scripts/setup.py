...
MINIMIZE_FUZZER_OVERRIDE = libFuzzer
ENABLE_GESTURES = False
THREAD_DELAY  = 30.0
"""
...
timeout_percent: "Percent of fuzzing runs that crashed on timeouts (should be 0)"
...
runs_count: "Number of libFuzzer fuzzing runs or sessions (max 1 hr long)"
...
timeout_percent: "Percent of fuzzing runs had testcases timeout"
startup_crash_percent: "Percent of fuzzing runs that crashed on startup (should be 0)"
avg_unwanted_log_lines: "Average number of unwanted log lines in fuzzing runs (should be 0)"
runs_count: "Number of libFuzzer fuzzing runs or sessions (max 1 hr long)"
logs: "Link to fuzzing logs"
