...
_SETUPBUILDRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fuzz_targets_count', full_name='SetupBuildResponse.fuzz_targets_count', index=7,
...
_ENGINEFUZZRESPONSE = _descriptor.Descriptor(
  ...
  nested_types=[_ENGINEFUZZRESPONSE_STATSENTRY, _ENGINEFUZZRESPONSE_FUZZERMETADATAENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
