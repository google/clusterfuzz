...
def main(args):
    ...
    if args.model_name.upper() == 'RANDOM':
        ...
        generator = RandomDeleteGenerator(
            args.input_dir,
            args.pos_change,
            args.generate_batch_size)
    elif args.model_name.upper() == 'RNN':
        generator = RNNGenerator(
            args.hidden_layer_number,
        ...
        generator = GPTGenerator(
            args.hidden_layer_number,
            constants.DEFAULT_GPT_D_MODEL,
            constants.DEFAULT_GPT_NUM_HEADS,
            args.hidden_state_size,
        ...
        generator = BERTBatchGenerator(
            args.hidden_layer_number,
            constants.DEFAULT_BERT_D_MODEL,
            constants.DEFAULT_BERT_NUM_HEADS,
            args.hidden_state_size,
            args.predict_window_size,
            args.dropout_pkeep,
            args.model_weights_path,
        ...
        exit(constants.ExitCode.TENSORFLOW_ERROR)
    ...
    while new_units_count < args.count:
        ...
        for i in range(args.generate_batch_size):
            ...
            print(f'generate input: {new_file_path}, input length: {len(new_files_bytes[i])}')
