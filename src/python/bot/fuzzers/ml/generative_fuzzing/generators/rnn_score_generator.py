...
class RNNScoreGenerator:
  ...
  def __init__(self, hidden_layer_number, hidden_state_size,
    ...
    "pos_change must be greater than 0 in RNN score strategy."
    self.corpus_files_info = utils.get_files_info(
        input_dir, pos_change != 0)
  ...
  def generate(self):
    ...
    for _ in range(self.batch_size):
      print(f"file {_ + 1}/{self.batch_size}", end='\r')
