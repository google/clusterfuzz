...
class GroupLeaderTest(unittest.TestCase):
  ...
  def _make_attributes(self, one_time_crasher_flag, issue_id, group_id,
                       time_in_second):
    attributes = grouper.TestcaseAttributes()
  ...
  def test_choose_has_issue_over_reproducible(self):
    ...
    testcase_map = {
        '1': self._make_attributes(False, None, 22, 10),
        '2': self._make_attributes(True, '9', 22, 1),
    }
    group_leader.choose(testcase_map)
