...
class OssFuzzSetupTest(unittest.TestCase):
  ...
  def test_execute(self):
    ...
    unmanaged_topic_name = pubsub.topic_name(utils.get_application_id(),
                                             'jobs-linux')
    old_topic_name = pubsub.topic_name(utils.get_application_id(),
                                       'jobs-shouldbedeleted')
    old_subscription_name = pubsub.subscription_name(utils.get_application_id(),
                                                     'jobs-shouldbedeleted')
    other_topic_name = pubsub.topic_name(utils.get_application_id(), 'other')
