...
class TestStrategySelectionPatchless(unittest.TestCase):
  ...
  def test_default_pool_generator(self):
    ...
    strategy_selection.generate_default_strategy_pool(strategy_list=strategy.LIBFUZZER_STRATEGY_LIST, use_generator=True)
...
class TestMultiArmedBanditStrategySelectionPatch(unittest.TestCase):
  ...
  def test_multi_armed_bandit_strategy_pool(self):
    ...
    strategy_selection.generate_weighted_strategy_pool(strategy_list=strategy.LIBFUZZER_STRATEGY_LIST, use_generator=True)
